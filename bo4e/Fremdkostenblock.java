...
public class Fremdkostenblock {
     ...
     */
    public List<Fremdkostenposition> getKostenpositionen() { return kostenpositionen; }
    public void setKostenpositionen(List<Fremdkostenposition> value) { this.kostenpositionen = value; }
