 ...
 */
public class RegionalerAufAbschlag {
    private String id;
     ...
     */
    public List<RegionalePreisstaffel> getStaffeln() { return staffeln; }
    public void setStaffeln(List<RegionalePreisstaffel> value) { this.staffeln = value; }
