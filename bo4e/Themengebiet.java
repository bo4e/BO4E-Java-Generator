...
public enum Themengebiet {
    ...
    public String toValue() {
        switch (this) {
            ...
            case BEWEGUNGSDATEN: return "BEWEGUNGSDATEN";
            ...
            case EINSPEISUNG: return "EINSPEISUNG";
    ...
    public static Themengebiet forValue(String value) throws IOException {
        ...
        if (value.equals("BEWEGUNGSDATEN")) return BEWEGUNGSDATEN;
        ...
        if (value.equals("EINSPEISUNG")) return EINSPEISUNG;
