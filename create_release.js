...
function main(version) {
    const release_infos = get_release_infos(version);
    const is_latest = version === get_latest_release_tag();
    create_release(version, release_infos, is_latest).then(console.log);
}
